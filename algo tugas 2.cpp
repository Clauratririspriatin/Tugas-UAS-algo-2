...
switch(pilihmenu){
	case 1:
		// case 1 untuk memilih pricelist
		// untuk memilih pricelist menggunakan cout
	...
	case 2:
		// case 2 untuk mencari barang yg kita inginkan 
		// untuk mrancari harga barang menggunakan  sequential search, sequential search kyaiitu algoritma untuk menemukan nilai tertentu 
		//dalam array 1 dimensi yang memeriksa setiap elemen secara berurutan dari awal sampai akhir hingga elemennya ditemukan atau daftar elemennya
	{
	...
	case 3:	
	// case 3  untuk memulai order atau barang yang ingin dibeli
	// untuk memulai order menggunakan array, karena array merupakan sebuah tipe data yang berisi kumpulan data atau banyak nilai dengan
	// tipe data yang sama, dengan menggunakan array kita dapat mengetahui berapa dan jenis barang yang ingin dibeli
	{
		cout << "===== Pricelist Toko Baju Sederhana =====" << endl;
		cout << "1. Baju : Rp. 50.000" << endl;
		cout << "2. Celana : Rp. 100.000" << endl;
